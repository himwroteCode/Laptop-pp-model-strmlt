...
# Get the absolute path of the files
data_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "resources", "data", "df22.pkl"))
model_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "resources", "data", "model.pkl"))
...
selected = st.sidebar.selectbox('App content Guide', options)

# use the selected option to control the display of content in the main area
if selected == 'About this app':
    st.write('This is a web app that predicts the price of a laptop based on its specifications.')
...
################################################################################################################
elif selected == 'Laptop Market Analysis':
    st.snow()
